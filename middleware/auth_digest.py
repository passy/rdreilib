...
# (c) 2009 Pascal Hartig <phartig@weluse.de>
# This module is part of the Python Paste Project and is released under
# the MIT License: http://www.opensource.org/licenses/mit-license.php
# This code was written with funding by http://prometheusresearch.com
"""
rdreilib.middleware.auth_digest
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
import hashlib, time, random, urllib2, logging

log = logging.getLogger('rdreilib.middleware.auth_digest')

class Unauthorized(_Unauthorized):
    """Exception providing a special headers parameter."""

    def __init__(self, description=None, headers=None):
        self.headers = headers
        super(Unauthorized, self).__init__(description)
...
class AuthDigestAuthenticator(object):
    ...
    def build_authentication(self, stale = ''):
        ...
        raise Unauthorized(headers=head)
    ...
    def __call__(self, environ):
        ...
        try:
            return self.authenticate(environ)
    ...
    def __call__(self, environ, start_response):
        ...
        if not username:
            ...
            if isinstance(result, str):
                ...
                response = result.get_response(environ)
